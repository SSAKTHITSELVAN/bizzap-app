...
//       // Fetch leads and subscription in parallel
//       const [leadsResponse, subscriptionResponse] = await Promise.all([
//         leadsAPI.getAllLeads(),
//         subscriptionAPI.getCurrentSubscription(),
//       ]);
      
//       if (leadsResponse.status === 'success' && leadsResponse.data) {
//         const activeLeads = leadsResponse.data.filter(
//           lead => !lead.isDeleted && lead.isActive
//         );
