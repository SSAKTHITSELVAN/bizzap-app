...
export default function AccountsCenterScreen() {
    ...
    const handleUnfollowConfirm = async () => {
        ...
        try {
            ...
            // Update local state to remove unfollowed company
    ...
    const handleShareProfile = async () => {
        try {
            const message = `Check out ${user?.companyName}'s profile on Bizzap!`;
            await Share.share({
                message: message,
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>{user.userName || user.companyName}</Text>
                <TouchableOpacity 
                ...
                <View style={styles.profileHeader}>
                    ...
                    <View style={styles.profileInfoContainer}>
                        ...
                        <View style={styles.avatarContainer}>
                            <Image
                                source={{ uri: user.userPhoto || user.logo || PLACEHOLDER_IMG }}
                                style={styles.avatar}
                                defaultSource={{ uri: PLACEHOLDER_IMG }}
                            />
                        </View>
