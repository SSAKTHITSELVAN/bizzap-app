...
const HEADER_HEIGHT = sizeScale(160); // Increased height for new button
        ...
        <SafeAreaView edges={['top']} style={styles.headerSafeArea}>
          <View style={styles.headerContent}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => router.push('/lead/products')}
            >
              <View style={styles.productsButtonContent}>
                <Ionicons name="cube-outline" size={sizeScale(20)} color="#8b5cf6" />
