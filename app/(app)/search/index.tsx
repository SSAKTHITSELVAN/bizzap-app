...
//   onPress: () => void;
// }) => (
//   <TouchableOpacity style={styles.trendingItem} onPress={onPress} activeOpacity={0.7}>
//     <View style={styles.trendingIcon}>
//       <Ionicons name="trending-up" size={sizeScale(20)} color="#0095f6" />
//     </View>
//     <View style={styles.trendingContent}>
//       <Text style={styles.trendingText}>{query}</Text>
//       <Text style={styles.trendingCategory}>{category}</Text>
//     </View>
//     <Ionicons name="arrow-up-outline" size={sizeScale(18)} color="#666" />
//   </TouchableOpacity>
// );

// // --- Company Result Card ---
// const CompanyResultCard = ({ company }: { company: Company }) => (
//   <TouchableOpacity style={styles.companyResultCard} activeOpacity={0.7}>
//     <Image
...
//       <Text style={styles.companyResultName} numberOfLines={1}>{company.companyName}</Text>
//       <Text style={styles.companyResultCategory} numberOfLines={1}>{company.category || 'Business'}</Text>
//       <Text style={styles.companyResultFollowers}>{company.followersCount || 0} followers</Text>
//     </View>
...
//   <TouchableOpacity style={styles.leadResultCard} activeOpacity={0.7}>
//     {lead.image ? (
...
//         />
//         <Text style={styles.leadResultCompanyName} numberOfLines={1}>{lead.company.companyName}</Text>
//       </View>
...
//   <TouchableOpacity style={styles.productGridItem} activeOpacity={0.7}>
//     <Image
//       source={{
...
//         <FlatList
//           data={companies.data}
//           renderItem={({ item }) => <CompanyResultCard company={item} />}
...
//             <TrendingItem
//               query="Tech Startups India"
//               category="Companies"
//               onPress={() => setSearchQuery('Tech Startups India')}
//             />
//             <TrendingItem
//               query="B2B Manufacturing"
//               category="Leads"
//               onPress={() => setSearchQuery('B2B Manufacturing')}
//             />
//             <TrendingItem
//               query="Electronics Wholesale"
//               category="Products"
//               onPress={() => setSearchQuery('Electronics Wholesale')}
//             />
//             <TrendingItem
//               query="Export Business"
//               category="Companies"
//               onPress={() => setSearchQuery('Export Business')}
//             />
//             <TrendingItem
//               query="Textile Industry"
//               category="Leads"
//               onPress={() => setSearchQuery('Textile Industry')}
//             />
//           </View>
//         </ScrollView>
//       )}
