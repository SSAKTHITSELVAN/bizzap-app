...
// // // app/(app)/notification/index.tsx - Updated with Debug Button
// // import React, { useState, useRef } from 'react';
// // import {
// //   View,
// //   Text,
...
// // // ... (keep your SwipeableNotification component exactly as is)
...
// //       {/* ✅ Updated Header with Debug Button */}
// //       <View style={[
// //         styles.header, 
// //         { 
// //           paddingTop: insets.top + 10,
...
// //             onPress={() => router.push('/(app)/notification-debug' as any)}
// //             activeOpacity={0.7}
// //           >
...
//   // Show debug button in DEV or for internal preview/staging environments
//   const showDebugButton = __DEV__ || process.env.NODE_ENV !== 'production';
...
//         {/* Updated Debug Button logic for Preview builds */}
//         {showDebugButton && (
//           <TouchableOpacity
//             style={styles.debugButton}
//             onPress={() => router.push('/(app)/notification-debug' as any)}
